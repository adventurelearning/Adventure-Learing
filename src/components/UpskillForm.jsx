...
function UpskillForm() {
  ...
  const validateForm = () => {
    ...
    if (formData.phone_number.trim()) {
      if (!/^\+?\d{1,}([\s-]?\d+)*$/.test(formData.phone_number)) {
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-2 border ${errors.title ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition ${errors.phone_number ? 'border-red-500' : 'border-gray-300'}`}
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition ${errors.company_name ? 'border-red-500' : 'border-gray-300'}`}
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition ${errors.message ? 'border-red-500' : 'border-gray-300'}`}
            ...
            {submitSuccess && (
              <p className="text-green-500 mt-2 text-center">Your request has been submitted successfully!</p>
            )}
          </form>
        </div>
      </div>
