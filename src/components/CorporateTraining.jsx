        ...
        <div className="bg-gray-100 ">
          <a href='#corpform'>
            {loading ? (
              ...
              <img src={corporatetrain} alt="Corporate Training Banner" />
            )}
          </a>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
          <div className="text-center mb-12 lg:mb-16">
            <h2 className="text-2xl lg:text-3xl font-semibold text-[#0057D3] mb-4">
              {loading ? <div className="w-64 h-8 bg-gray-300 rounded-md mx-auto"></div> : "Programs Delivered for Your Training Needs"}
            </h2>
            <p className="text-lg font-normal text-gray-600 max-w-3xl mx-auto">
              {loading ? <div className="w-80 h-6 bg-gray-300 rounded-md mx-auto"></div> : "Flexible training solutions designed to fit your organization's requirements"}
            </p>
          </div>
