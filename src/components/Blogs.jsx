  ...
  return (
    <div className="bg-gradient-to-b from-blue-200 to-white py-8 md:py-10 rounded-md text-center px-4">
      ...
      <p className="text-gray-600 text-base mb-6 md:mb-8">
        Explore the top blog categories, trends, and insights to enhance your
        knowledge
      </p>
          ...
          >
            ...
            <div className="p-4 text-left">
              ...
              <div className="flex items-center">
                <Link
                  to={`subblogs/${card.link}`}
                  className="text-blue-500 mt-3 inline-flex items-center font-bold hover:underline"
                >
                  Read More
                  <span className="ml-2">
                    <svg
