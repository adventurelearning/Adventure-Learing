...
const data = [
  {
    title: 'Beginners',
    description: 'No prior experience? We’ll guide you step by step.',
  },
  {
    title: 'Aspiring Developers',
    description: 'Want to specialize in data analyst? This is for you.',
  },
  {
    title: 'Career Changers',
    description: 'Switching to data analytics? Get started with the basics and build your way up.',
  },
  {
    title: 'Students/Graduates',
    description: 'Boost your job prospects with solid data analytics skills.',
  },
  {
    title: 'Tech Enthusiasts/Entrepreneurs',
    description: 'Build personal projects or offer data analytics services to clients.',
  },
];
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          <div className="px-4 sm:px-6 lg:px-8 py-6 max-w-4xl mx-auto text-center">
            <h3 className="text-2xl lg:text-3xl font-semibold text-black mb-4">
              <span className="text-[#0057D3]">Data Analytics</span> Training Learning Path
            </h3>
            <p className="text-gray-600 text-lg mb-6 max-w-3xl mx-auto">
              This course is perfect for anyone interested in data analytics, 
