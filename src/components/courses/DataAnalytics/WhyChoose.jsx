    ...
    <>
      ...
      <div className="container-fluid mx-auto px-4 py-16 bg-gradient-to-br from-blue-50 to-blue-100 text-center">
        <div className="p-3 mx-auto max-w-6xl">
          ...
          {/* Why Choose Us */}
          <h2 className="text-2xl lg:text-3xl font-semibold text-[#0057D3] mb-6">
            Why Choose Adventure Learning for the Data Analytics Training
          </h2>
          <p className="mb-6">
          ...
          <h3 className="text-2xl font-semibold text-[#0057D3] mb-4">Where You Can Go:</h3>
          ...
          <p className="mb-6">
            This course is perfect for anyone interested in data analytics, whether you're a beginner or looking to advance your skills.
          </p>
          <table className="min-w-full table-auto border border-gray-300 bg-white text-left mb-12">
            <thead className="bg-[#0057D3] text-white">
              <tr>
                <th className="px-6 py-3 text-lg font-semibold w-1/3">Who is it for?</th>
            ...
            <tbody className="text-gray-800">
              {[
                ...
                ["Aspiring Data Analysts", "Want to become a data analyst? This course is for you."],
                ["Career Changers", "Switching to data analytics? Get started with the basics and build your way up."],
                ["Students/Graduates", "Boost your job prospects with solid data analytics skills."],
                ["Tech Enthusiasts/Entrepreneurs", "Build personal projects or offer data analytics services to clients."],
              ].map(([who, why], index) => (
                <tr key={index} className="border-t border-gray-300">
                  <td className="px-6 py-4 font-medium align-top">{who}</td>
                  <td className="px-6 py-4 align-top">{why}</td>
                </tr>
              ))}
            </tbody>
          </table>
          ...
          <table className="min-w-full table-auto border border-gray-300 bg-white text-left mb-12">
            <thead className="bg-[#0057D3] text-white">
              <tr>
                <th className="px-6 py-3 text-lg font-semibold w-1/3">Feature</th>
                <th className="px-6 py-3 text-lg font-semibold">Details</th>
              </tr>
            </thead>
            <tbody className="text-gray-800">
              {[
                ["Comprehensive Curriculum", "Learn key data analytics concepts, from data analysis to machine learning."],
                ["Hands-On Projects", "Work on real-world projects to apply your learning."],
                ["Expert Guidance", "Get insights from experienced instructors in the data analytics field."],
                ...
                <tr key={index} className="border-t border-gray-300">
                  <td className="px-6 py-4 font-medium align-top">{feature}</td>
                  <td className="px-6 py-4 align-top">{detail}</td>
                </tr>
              ))}
            </tbody>
          </table>
