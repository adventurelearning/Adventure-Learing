...
const careerPaths = [
  ...
  {
    title: "Data Analyst",
    description: "Use statistical methods to collect, organize, and analyze data.",
    icon: (
  ...
  },
  {
    ...
    description: "Design and implement machine learning models to predict trends and behaviors.",
    icon: (
  ...
  {
    title: "Data Engineer",
    description: "Build systems and architecture to collect, store, and process data efficiently.",
    icon: (
    ...
    <div className="bg-blue-50  py-8 px-4 sm:px-6 lg:px-4 mt-8 rounded-xl ">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          Discover innovative career paths in data analytics and insights-driven development.
          </p>
        </motion.div>
