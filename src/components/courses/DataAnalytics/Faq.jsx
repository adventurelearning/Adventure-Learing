  ...
  const faqItems = [
    {
      ...
      answer:
    'No prior experience in data analytics is required. We start from the basics, and anyone with an interest in data can join, whether you\'re from a technical or non-technical background.'
    },
    {
      question: 'What technologies will I learn?',
      answer:
    'You will primarily learn Python, SQL and R, which are widely used in data analytics for data manipulation, analysis, and machine learning tasks'
    },
    {
      question: 'What tools and software will I use during the course?',
      answer:
  'You will work with tools like Jupyter Notebooks, Pandas, NumPy, Power BI, Matplotlib, Seaborn, SQL, and TensorFlow to work with data and build machine learning models.'
    },
    {
      question: 'Is the course suitable for beginners?',
      answer:
   'Yes, the course is designed to take you from basic concepts to advanced techniques, making it perfect for beginners. No prior experience in data analytics or programming is required.'
    },
    {
      question: 'Will I be working on real-world projects?',
      answer:
   'Yes, the course includes hands-on projects that simulate real-world data analytics challenges. You\'ll work on data analysis, machine learning models, and data visualization projects to build your portfolio.'
    },
    {
