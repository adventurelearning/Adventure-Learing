...
const Faq = () => {
  const faqItems = [
    ...
    },
    {
      ...
      answer:
        'You’ll learn programming languages like C and C++, work with microcontrollers, embedded Linux, IoT platforms, sensors, and tools like Arduino, Raspberry Pi, and more at Adventure Learning.'
    },
    {
      question: 'How long is the course?',
      answer:
   "The course typically takes 3 to 6 months, depending on whether you study full-time or part-time at Adventure Learning"
    },
    {
      question: 'Will I get a certificate?',
      answer:
      'Yes, you’ll receive a certificate from Adventure Learning upon completing the course, highlighting your embedded systems skills' 
    },
    {
      question: 'Do you offer online and offline options?',
      answer:
    'Yes, Adventure Learning provides both online and offline learning options to suit your preferences and schedule'
    },
    {
      question: 'What is the course structure?',
      answer:
   'The course at Adventure Learning covers embedded systems programming, microcontrollers, real-time operating systems (RTOS), IoT applications, debugging, and optimization, followed by hands-on projects and a capstone project.'
