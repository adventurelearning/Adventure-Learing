    ...
    <div className="w-full px-4 sm:px-6 md:px-8 lg:px-12">
      <div className="relative rounded-xl overflow-hidden min-h-[200px]">
        ...
        <div 
          ...
          style={{
            backgroundImage: `url('https://img.freepik.com/free-photo/home-made-robot-desk_23-2148863420.jpg?t=st=1745306318~exp=1745309918~hmac=05649e24296916c20e8154ba6c4c6a535640f9df81d03edcdf6c102c78dabdb3&w=996')`,
          }}
        />
        ...
        <div className="relative z-10 p-6 sm:p-8 md:p-8 h-full flex flex-col justify-end">
          <div className="max-w-7xl mx-auto">
            ...
            You'll work on real-world embedded hardware and software projects, 
            building a strong portfolio while learning to troubleshoot, design, and optimize embedded systems like a pro.
            </p>
          </div>
        </div>
      </div>
