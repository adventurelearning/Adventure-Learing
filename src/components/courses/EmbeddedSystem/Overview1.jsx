...
const careerPaths = [
  {
    ...
    description: "Design and develop hardware and software for embedded systems in various industries.",
    icon: (
  ...
  },
  {
    ...
    description: "Write low-level software that interacts directly with hardware to control devices.",
    icon: (
  ...
  {
    title: "IoT Developer",
    description: "Connect physical devices to the internet and build smart solutions.",
    icon: (
  ...
  },
  {
    ...
    description: "Design and test the hardware components of embedded systems.",
    icon: (
  ...
  },
  {
    ...
    description: "Plan and build complex embedded systems architecture.",
    icon: (
    ...
    <div className="bg-blue-50  py-8 px-4 sm:px-6 lg:px-4 mt-8 rounded-xl ">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          Discover innovative career paths in embedded systems design and development
          </p>
        </motion.div>
