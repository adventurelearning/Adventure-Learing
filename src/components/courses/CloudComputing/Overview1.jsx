...
const careerPaths = [
  {
    ...
    description: "Build and manage cloud infrastructure on AWS, Azure, or GCP.",
    icon: (
  ...
  },
  {
    ...
    description: "Automate deployment pipelines using Jenkins, Docker, Git, and Terraform.",
    icon: (
  ...
  },
  {
    ...
    description: "Manage cloud services, monitor performance, and ensure uptime.",
    icon: (
  ...
  },
  {
    ...
    description: "Ensure system stability using automation and performance monitoring tools.",
    icon: (
  ...
  },
  {
    ...
    description: "Secure cloud environments with access controls, monitoring, and compliance.",
    icon: (
    ...
    <div className="bg-blue-50  py-8 px-4 sm:px-6 lg:px-4 mt-8 rounded-xl ">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          Discover innovative career paths in cloud architecture and service development
          </p>
        </motion.div>
