    ...
    <>
      ...
      <div className="container-fluid mx-auto px-4 py-16 bg-gradient-to-br from-blue-50 to-blue-100 text-center">
        <div className="p-3 mx-auto">
          ...
          <p className="mb-6">At Adventure Learning, we focus on a hands-on, practical approach to learning Cloud Computing. Our experienced instructors guide you through real-world projects, ensuring you're equipped with the skills needed to succeed in the Cloud Computing industry.
          </p>
