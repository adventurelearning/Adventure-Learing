    ...
    <div className="w-full px-4 sm:px-6 md:px-8 lg:px-12">
      <div className="relative rounded-xl overflow-hidden min-h-[200px]">
        ...
        <div 
          ...
          style={{
            backgroundImage: `url('https://d1ub0o53i85pdh.cloudfront.net/uploads/2021/09/Facebook-Linkedin-image-template-10.jpg')`,
          }}
        />
        ...
        <div className="relative z-10 p-6 sm:p-8 md:p-8 h-full flex flex-col justify-end">
          <div className="max-w-7xl mx-auto">
            ...
            Live Projects in the Fullstack development Course
            ...
            You’ll work on live full-stack projects, building front-end interfaces,
             developing back-end logic, and deploying real-world applications. 
            By the end, you’ll have a complete full-stack project in your portfolio
            </p>
          </div>
        </div>
      </div>
