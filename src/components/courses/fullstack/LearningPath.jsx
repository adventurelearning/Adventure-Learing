...
const data = [
  {
    title: 'Beginners',
    description: "If you have no coding experience, we'll guide you step by step."
  },
  {
    title: 'Aspiring Developers',
    description: 'Want to become a full-stack developer? This is your roadmap.'
  },
  {
    title: 'Career Changers',
    description: 'Looking to switch to tech? Full-stack development is the way in.'
  },
  {
    title: 'Students/Graduates',
    description: 'Ready to stand out in the job market? Sharpen your skills here.'
  },
  {
    title: 'Freelancers/Entrepreneurs',
    description: 'Build your own projects or offer full-stack services to clients.'
  }
]
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          <div className="px-4 sm:px-6 lg:px-8 py-6 max-w-4xl mx-auto text-center">
            <h3 className="text-2xl lg:text-3xl font-semibold text-black mb-4">
              Full Stack <span className="text-[#0057D3]"> Web Development </span>  Learning  Path
            </h3>
            <p className="text-gray-600 text-lg mb-6 max-w-3xl mx-auto">
              This course is perfect for anyone interested in Full Stack Web Development, whether you're a beginner or looking to advance your skills.
            </p>
          </div>
