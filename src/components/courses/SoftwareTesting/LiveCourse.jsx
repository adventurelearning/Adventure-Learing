    ...
    <div className="w-full px-4 sm:px-6 md:px-8 lg:px-12">
      <div className="relative rounded-xl overflow-hidden min-h-[200px]">
        ...
        <div 
          ...
          style={{
            backgroundImage: `url('https://media.istockphoto.com/id/1413997805/vector/software-application-testing-concept-3d-illustration.jpg?s=612x612&w=0&k=20&c=dYeXZ072rhISYi1sy7GtN4YWIZ1VpXFxWAziq1qA27s=')`,
          }}
        />
        ...
        <div className="relative z-10 p-6 sm:p-8 md:p-8 h-full flex flex-col justify-end">
          <div className="max-w-7xl mx-auto">
            ...
            Live Projects in the Software Testing Course
            ...
            You’ll work on live testing projects, automating test cases, running performance checks,
             and writing test plans for real-world applications. 
            By the end, you’ll have a full QA project in your portfolio.
            </p>
          </div>
        </div>
      </div>
