...
<h2 className="text-2xl lg:text-3xl font-semibold text-[#0057D3] mb-4"> Why Choose Adventure Learning for the Data Analytics Training
          </h2>

          <p  className="mb-6">At Adventure Learning, we focus on a hands-on, practical approach to learning Data Analytics. Our experienced instructors guide you through real-world projects, ensuring you're equipped with the skills needed to succeed in the data analytics industry.
          </p>
