...
const careerPaths = [
  {
    title: "Manual Tester",
    description: "Ensure software works as expected through functional and regression testing.",
    icon: (
  ...
  },
  {
    ...
    description: "Create test scripts using Selenium, Java, JavaScript, and frameworks like TestNG and JUnit.",
    icon: (
  ...
  {
    title: "API Tester",
    description: "Test backend services using Postman, Rest Assured, and SoapUI.",
    icon: (
  ...
  },
  {
    ...
    description: "Use tools like Apache JMeter and LoadRunner to test system speed and reliability.",
    icon: (
  ...
  },
  {
    ...
    description: "Test iOS/Android apps using Appium",
    icon: (
  ...
  {
    title: "QA Analyst",
    description: "Analyze and improve software quality in agile teams.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 text-red-600">
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.429 9.75L2.25 12l4.179 2.25m0-4.5l5.571 3 5.571-3m-11.142 0L2.25 7.5 12 2.25l9.75 5.25-4.179 2.25m0 0L21.75 12l-4.179 2.25m0 0l4.179 2.25L12 21.75 2.25 16.5l4.179-2.25m11.142 0l-5.571 3-5.571-3" />
      </svg>
    ...
    title: "DevOps/CI Tester",
    description: "Use Jenkins, Git, and Allure to integrate testing into CI/CD pipelines.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 text-red-600">
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.429 9.75L2.25 12l4.179 2.25m0-4.5l5.571 3 5.571-3m-11.142 0L2.25 7.5 12 2.25l9.75 5.25-4.179 2.25m0 0L21.75 12l-4.179 2.25m0 0l4.179 2.25L12 21.75 2.25 16.5l4.179-2.25m11.142 0l-5.571 3-5.571-3" />
      </svg>
    ...
    <div className="bg-blue-50  py-8 px-4 sm:px-6 lg:px-4 mt-8 rounded-xl ">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          Discover innovative career paths in software testing and quality assurance
          </p>
        </motion.div>
