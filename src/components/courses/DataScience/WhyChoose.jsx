    ...
    <div className="container-fluid mx-auto px-4 py-16 bg-gradient-to-br from-blue-50 to-blue-100">
      <div className="p-3 mx-auto">
        ...
        Overview of the Data Science Course
          ...
          <h2 className="text-2xl lg:text-3xl font-semibold text-[#0057D3] mb-6">
          Best Data Science Courses Online and Offline
          </h2>

          <p>
          At Adventure Learning, we offer the best Data Science courses, available both online and offline, designed to suit your learning style. Whether you prefer the flexibility of online learning or the hands-on experience of classroom sessions, our course will equip you with the skills to become a data science expert.
          </p>
          <hr className="border-t border-blue-300 w-3/5 mx-auto my-12" />
          <h2 className="text-2xl lg:text-3xl font-semibold text-[#0057D3] mb-6"> Why Choose Adventure Learning for the Data Science Course
      </h2>

    <p>At Adventure Learning, we focus on a hands-on, practical approach to learning Data Science. Our experienced instructors guide you through real-world projects, ensuring you're equipped with the skills needed to succeed in the data science industry.</p>
...
<div>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 ">
          ...
          <p className="mb-6">
          Upon completing your Data Science training, you’ll be ready to enter a wide range of exciting roles in the fast-growing field of data. The demand for data scientists is booming, and your new skills will open doors to career opportunities with great potential for growth.
          </p>
          <h2 className="text-2xl lg:text-3xl font-semibold text-[#0057D3] my-6">
...
Data Science Training Learning Path
</h3>
<p> 
 	
   This course is perfect for anyone interested in data science, whether you're a beginner or looking to advance your skills.</p>
<table className="min-w-full table-auto border border-gray-300 rounded-lg overflow-hidden text-justify">
    ...
    <tbody className="text-gray-800 bg-white">
      ...
      <tr className="border-t border-gray-300">
        <td className="px-6 py-4 font-medium align-top">Aspiring Data Scientists</td>
        <td className="px-6 py-4 align-top">
        Want to become a data scientist? This course is for you.
        </td>
      </tr>
      <tr className="border-t border-gray-300">
        <td className="px-6 py-4 font-medium align-top">Career Changers</td>
        <td className="px-6 py-4 align-top">
        Switching to data science? Get started with the basics and build your way up.
        </td>
      </tr>
      <tr className="border-t border-gray-300">
        <td className="px-6 py-4 font-medium align-top">Students/Graduates</td>
        <td className="px-6 py-4 align-top">
        Boost your job prospects with solid data science skills.
        </td>
      </tr>
      <tr className="border-t border-gray-300">
        <td className="px-6 py-4 font-medium align-top">Tech Enthusiasts/Entrepreneurs</td>
        <td className="px-6 py-4 align-top">
        Build personal projects or offer data science services to clients.
        </td>
      </tr>
    </tbody>
  </table>
  ...
  <table className="min-w-full table-auto border border-gray-300 rounded-lg overflow-hidden text-justify">
    ...
    <tbody className="text-gray-800 bg-white">
      <tr className="border-t border-gray-300">
        ...
        <td className="px-6 py-4 align-top">Learn key data science concepts, from data analysis to machine learning.</td>
      </tr>
      <tr className="border-t border-gray-300">
      ...
      <tr className="border-t border-gray-300">
        ...
        <td className="px-6 py-4 align-top">Get insights from experienced instructors in the data science field.</td>
      </tr>
      <tr className="border-t border-gray-300">
