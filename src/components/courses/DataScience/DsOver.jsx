...
import img1 from '../../../assets/img/ds1.webp'
import img2 from '../../../assets/img/ds2.webp'
import img3 from '../../../assets/img/ds3.webp'
import img4 from '../../../assets/img/ds4.webp'
...
const DsOver = () => {
    ...
    const courseContent = [
        ...
        {
            question: 'Best Data Science Courses Online and Offline',
            answer:
        ...
        {
            question: 'Why Choose Adventure Learning for the Data Science Course',
            answer:
        ...
        <div className="container mx-auto px-4 py-12 max-w-7xl bg-blue-50 rounded-xl">
            <div className="text-center mb-16">
                ...
                <h4 className="font-normal text-lg text-gray-600 max-w-2xl mx-auto">
                    Kickstart your tech career with our Complete Advanced Data Science
                </h4>
            </div>
