    ...
    <AnimatePresence>
      {showPopup && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0  flex items-center justify-center p-4 bg-gray-700 bg-opacity-50 overflow-y-auto"
          style={{
        ...
        >
          <a href="https://www.adventurelearning.co.in/course/full-stack-development">
            <motion.div
